...
export const getAltas = (
  ...
  const churnTeorico =
    assumptionData[0].churns[indexCanal].items[indexProd].porcentajeChurn;
...
export const getValueMes = (
  ...
  volumenData[indexPais].stats[indexCanal].productos[indexProd].años[indexYear]
    .volMeses[MONTHS[indexMes]];

const churnPorcentaje = (
  indexPais,
  indexCanal,
  indexProd,
  volumenData,
...
export const modifyDataWithInitialClients = (
  originalData,
  volumenData,
  assumptionData,
) => {
  ...
  paises.forEach((pais, indexPais) => {
    ...
    copy[pais].forEach((canal, indexCanal) => {
      ...
      canal.productos.forEach((prod, indexProd) => {
        prod.valoresInicioChurn = inicio(
          indexPais,
          indexCanal,
          indexProd,
          volumenData,
        ...
        prod.churnPorcetajes = churnPorcentaje(
          indexPais,
          indexCanal,
          indexProd,
          volumenData,
